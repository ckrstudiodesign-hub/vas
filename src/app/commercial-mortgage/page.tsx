...
export const metadata: Metadata = {
  title: 'Commercial Mortgage Services | VAS Consultants Dubai',
  description: 'Expert guidance for purchasing office space, retail outlets, or industrial properties in the UAE with customized commercial mortgage solutions.',
};
