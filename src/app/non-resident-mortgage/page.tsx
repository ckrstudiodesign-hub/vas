...
export const metadata: Metadata = {
  title: 'Non-Resident Mortgage Services | VAS Consultants Dubai',
  description: 'Specialized mortgage solutions for non-residents looking to buy property in Dubai and the UAE with seamless, stress-free guidance.',
};
