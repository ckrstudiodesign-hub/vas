...
export const metadata: Metadata = {
  title: 'IFZA Company Formation | VAS Consultants Dubai',
  description: 'Setup your company in IFZA (International Free Zone Authority) with 100% foreign ownership, zero paid-up capital, and full capital repatriation.',
};

export default function FreezoneIfzaPage() {
  return (
    <>
      <section className="about-hero-simple" style={{ background: "url('/images/navbar/IFZA%20Dubai.jpg') center/cover no-repeat", position: 'relative', padding: '120px 0 80px', textAlign: 'center' }}>
