...
export const metadata: Metadata = {
  title: 'Balance Transfer & Mortgage Refinance | VAS Consultants Dubai',
  description: 'Transfer your mortgage to reduce interest costs and monthly outlays, or cash out equity for business and investment opportunities in the UAE.',
};

export default function BalanceTransferRefinancePage() {
  return (
    <>
        ...
        <div className="container">
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <p style={{ fontSize: '1.1rem', lineHeight: 1.8, color: 'var(--color-dark-grey)', marginBottom: '48px' }}>
              If you wish to refinance and cash out your equity in the property, for the purpose of acquiring more properties and/or to assist in your business, we can provide the right solutions and ensure seamless execution.
            </p>
          </div>
        </div>
      </section>
