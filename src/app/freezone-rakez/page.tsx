...
export const metadata: Metadata = {
  title: 'RAKEZ Company Formation | VAS Consultants Dubai',
  description: 'Setup your company in RAKEZ (Ras Al Khaimah Economic Zone) with complete packages including licence, visa, flexi-desk, and Emirates ID.',
};

export default function FreezoneRakezPage() {
  return (
    <>
      <section className="about-hero-simple" style={{ background: "url('/images/navbar/RAKEZ – Ras Al Khaimah Economic Zone.jpg') center/cover no-repeat", position: 'relative', padding: '120px 0 80px', textAlign: 'center' }}>
